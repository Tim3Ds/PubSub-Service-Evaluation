...
class AsyncMessagingServiceImpl final : public MessagingService::Service {
private:
    int receiver_id;
    
public:
    AsyncMessagingServiceImpl(int id) : receiver_id(id) {}
...
int main(int argc, char** argv) {
    ...
    AsyncMessagingServiceImpl service(receiver_id);
